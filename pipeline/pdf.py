...
@page {
    ...
    @bottom-left {
        content: "CRAM-1 · free & open source · github.com/harjassgambhir/cram";
        font-size: 9pt;
        color: #888;
    }
}
...
/* Distribution footer — closes every report so a forwarded PDF still
   carries attribution and a route to report errors. */
.report-footer {
    margin-top: 24pt;
    padding-top: 10pt;
    border-top: 1px solid #ccd;
...
# Public repo — used in the PDF footer for attribution + error reporting.
_REPO_URL = "https://github.com/harjassgambhir/cram"
_ISSUE_URL = f"{_REPO_URL}/issues/new"

_REPORT_FOOTER_HTML = f"""<div class="report-footer">
Generated by <a href="{_REPO_URL}">CRAM</a> — free &amp; open-source clinical
evidence synthesis. This is a literature-synthesis brief for reference, not
treatment advice; every claim must be checked against its cited source.<br>
Spotted an error in this brief? <a href="{_ISSUE_URL}">Report it here.</a>
</div>"""
